...
//    private static final String HOST = "api.eactalk.com";
    // convenience getter for the API endpoint
    private static final String BASE_URL = PROTO + "://" + EactalkApp.HOST;
    //feePerKb url
    ...
    public void bundleDownloadTest() {
        ...
        Request request = new Request.Builder()
                .get()
                .url("https://s3.amazonaws.com/eactalk-assets/bread-buy/7f5bc5c6cc005df224a6ea4567e508491acaffdc2e4769e5262a52f5b785e261.tar").build();
...
//        Request request = new Request.Builder()
//                .get()
//                .url("https://s3.amazonaws.com/eactalk-assets/bread-buy/bundle.tar").build();
//        Response response = apiClient.sendRequest(request, false, 0);
//        byte[] bundleFileOldBytes = apiClient.writeBundleToFile(response);
//
//        request = new Request.Builder()
//                .get()
//                .url("https://s3.amazonaws.com/eactalk-assets/bread-buy/bundle2.tar").build();
//        response = apiClient.sendRequest(request, false, 0);
...
//        request = new Request.Builder()
//                .get()
//                .url("https://s3.amazonaws.com/eactalk-assets/bread-buy/bundle_bundle2.bspatch").build();
//        response = apiClient.sendRequest(request, false, 0);
...
//        Assert.assertTrue(oldFileBytes.length != 0 && correctFileBytes.length != 0);
    ...
    public void testBitIdSignature() {
        ...
        String message = "https://eactalk.com/bitid?nonce=123456789";
