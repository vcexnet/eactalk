...
import com.eactalk.presenter.customviews.BRButton;
...
import com.eactalk.tools.qrcode.QRUtils;
...
//        });
            ...
            public void run() {
                ...
                BRExecutor.getInstance().forMainThreadTasks().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        boolean generated = generateQrImage(receiveAddress, "0", "EAC");
                        if (!generated)
                            throw new RuntimeException("failed to generate qr image for address");
                    }
                });
    ...
    private boolean generateQrImage(String address, String strAmount, String iso) {
        ...
        return QRUtils.generateQR(getActivity(), "earthcoin:" + address + amountArg, mQrImage);
    }
