...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        BigDecimal amount = BRExchange.getAmountFromSatoshis(this, "EAC", satoshis);
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), BRCurrency.getFormattedCurrencyString(this, "EAC", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    }
