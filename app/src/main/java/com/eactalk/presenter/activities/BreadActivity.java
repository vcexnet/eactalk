package com.eactalk.presenter.activities;
...
import com.eactalk.presenter.customviews.BRSearchBar;
import com.eactalk.presenter.fragments.FragmentManage;
import com.eactalk.tools.animation.BRAnimator;
import com.eactalk.tools.animation.TextSizeTransition;
import com.eactalk.tools.manager.BRSharedPrefs;
import com.eactalk.tools.manager.InternetManager;
import com.eactalk.tools.manager.SyncManager;
import com.eactalk.tools.manager.TxManager;
...
import static com.eactalk.presenter.activities.SetPinActivity.introSetPitActivity;
import static com.eactalk.presenter.activities.intro.IntroActivity.introActivity;
import static com.eactalk.tools.util.BRConstants.PLATFORM_ON;
public class BreadActivity extends BRActivity implements BRWalletManager.OnBalanceChanged,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        primaryPrice.setTextSize(BRAnimator.primaryTextSize);
        secondaryPrice.setTextSize(BRAnimator.secondaryTextSize);

        if (introSetPitActivity != null) introSetPitActivity.finish();
        if (introActivity != null) introActivity.finish();
        if (ReEnterPinActivity.reEnterPinActivity != null) ReEnterPinActivity.reEnterPinActivity.finish();
    ...
    private void setPriceTags(boolean ltcPreferred, boolean animate) {
        ...
        primaryPrice.setTextSize(ltcPreferred ? BRAnimator.primaryTextSize : BRAnimator.secondaryTextSize);
        secondaryPrice.setTextSize(ltcPreferred ? BRAnimator.secondaryTextSize : BRAnimator.primaryTextSize);
    ...
    public void updateUI() {
        BRExecutor.getInstance().forLightWeightBackgroundTasks().execute(new Runnable() {
            ...
            public void run() {
                ...
                final String formattedBTCAmount = BRCurrency.getFormattedCurrencyString(BreadActivity.this, "EAC", btcAmount);
