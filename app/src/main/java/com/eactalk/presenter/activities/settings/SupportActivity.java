...
//        1、EAC介绍及使用教程，自动播放视频，视频文件https://eactalk.com/sc/course.mp4（中文）；https://vcexnet.github.io/img/course.mp4（english）
//        2、如何获得EAC？点击后，弹窗或者打开新页面。具体内容：“获取EAC的渠道有：1、挖矿(参见挖矿教程)；2、购买(参见购买EAC教程)”
//        3、购买EAC教程，自动播放视频，视频文件https://eactalk.com/sc/buy.mp4（中文）；https://vcexnet.github.io/img/buy.mp4（english）
//        4、提币到eactalk教程，自动播放视频，视频文件https://eactalk.com/sc/withdraw.mp4（中文）；https://vcexnet.github.io/img/withdraw.mp4（english）
//        5、挖EAC教程，自动播放视频，视频文件https://eactalk.com/sc/mining.mp4(中文)；https://vcexnet.github.io/img/mining.mp4(english)
//        6、如何部署earthcoin节点教程，视频文件：https://eactalk.com/sc/node.mp4(中文)；https://vcexnet.github.io/img/node.mp4(english)
//        7、支持交易所，直接获取内容页面嵌套（https://eactalk.com/sc/exchange.html；https://vcexnet.github.io/img/exchange.html）
//        8、支持矿池，直接获取内容页面嵌套（https://eactalk.com/sc/pool.html；https://vcexnet.github.io/img/pool.html）
//        9、支持eactalk的网站和应用，直接获取内容页面嵌套（https://eactalk.com/sc/support.html；https://vcexnet.github.io/img/support.html）
//        10、支持：dev@eactalk.com。仅仅显示即可。
        boolean isZh = isZh();
        Intent intent = null;
        switch (v.getId()) {
            case R.id.tv1:
                intent = new Intent(this,
                        VideoActivity.class);
                intent.putExtra("videoChineseUrl", "https://eactalk.com/sc/course.mp4");
            ...
            case R.id.tv3:
                intent = new Intent(this,
                        VideoActivity.class);
                intent.putExtra("videoChineseUrl", "https://eactalk.com/sc/buy.mp4");
            ...
            case R.id.tv4:
                intent = new Intent(this,
                        VideoActivity.class);
                intent.putExtra("videoChineseUrl", "https://eactalk.com/sc/withdraw.mp4");
            ...
            case R.id.tv5:
                intent = new Intent(this,
                        VideoActivity.class);
                intent.putExtra("videoChineseUrl", "https://eactalk.com/sc/mining.mp4");
            ...
            case R.id.tv9:
                ...
                intent.putExtra("url", isZh ?
                        "https://eactalk.com/sc/node.html"
            ...
            case R.id.tv6:
                ...
                intent = new Intent(this,
                        CusWebActivity.class);
                intent.putExtra("url", isZh ?
                        "https://eactalk.com/sc/exchange.html"
            ...
            case R.id.tv7:
                ...
                intent = new Intent(this,
                        CusWebActivity.class);
                intent.putExtra("url", isZh ?
                        "https://eactalk.com/sc/pool.html"
            ...
            case R.id.tv8:
                ...
                intent = new Intent(this,
                        CusWebActivity.class);
                intent.putExtra("url", isZh ?
                        "https://eactalk.com/sc/support.html"
