package com.eactalk.tools.adapter;
...
import com.eactalk.tools.manager.PromptManager;
...
import com.eactalk.tools.util.BRDateUtil;
...
//    }
    ...
    private void setTexts(final TxHolder convertView, int position) {
        ...
        String iso = isBTCPreferred ? "EAC" : BRSharedPrefs.getIso(mContext);
