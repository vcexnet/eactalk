package com.eactalk.tools.util;
...
public class BRConstants {
    ...
    public static String SUPPORT_EMAIL = "dev@eactalk.com";
...
//    public static final long MAX_FEE_PER_KB = (100100 * 1000 + 190) / 191;
    ...
    public static final String bitcoinLowercase = "\u0454";
    public static final String bitcoinUppercase = "\u0404";
    ...
    public static final Pair[] DONATION_ADDRESSES = new Pair[]
            {
                    Pair.create("eactalk Fundraiser", "eU1DkXy9Td9M2eSJGZqxiKgoQNjXS3Azck"),
                    Pair.create("Eactalk Fundraiser", "eS5KD8xF4QLmCWFJBsbMhB16TtpJyiqtLp")
            };
    ...
    public static final String TWITTER_LINK = "https://twitter.com/eactalk";
    public static final String REDDIT_LINK = "https://www.reddit.com/r/earthcoin";
    public static final String WEB_LINK = "https://eactalk.com";
    public static final String TOS_LINK = "https://eactalk.com/tos";

    public static final String BLOCK_EXPLORER_BASE_URL = BuildConfig.LITECOIN_TESTNET ? "http://api.deveac.com:3000/transaction/" : "http://api.eactalk.com:9000/transaction/";
