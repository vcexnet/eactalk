package com.eactalk.tools.security;
...
public class BRSender {
    ...
    private String createConfirmation(Context ctx, PaymentItem request) {
        ...
        String formattedAmountBTC = BRCurrency.getFormattedCurrencyString(ctx, "EAC", BRExchange.getBitcoinForSatoshis(ctx, new BigDecimal(request.amount)));
        String formattedFeeBTC = BRCurrency.getFormattedCurrencyString(ctx, "EAC", BRExchange.getBitcoinForSatoshis(ctx, new BigDecimal(feeForTx)));
        String formattedTotalBTC = BRCurrency.getFormattedCurrencyString(ctx, "EAC", BRExchange.getBitcoinForSatoshis(ctx, new BigDecimal(total)));
