...
import com.eactalk.presenter.activities.PaperKeyActivity;
import com.eactalk.presenter.activities.PaperKeyProveActivity;
import com.eactalk.presenter.activities.SetPinActivity;
import com.eactalk.presenter.activities.intro.WriteDownActivity;
import com.eactalk.presenter.activities.settings.WithdrawBchActivity;
...
import com.eactalk.tools.threads.PaymentProtocolPostPaymentTask;
        ...
        if (serializedTx == null) {
            ...
            BRExecutor.getInstance().forLightWeightBackgroundTasks().execute(new Runnable() {
                ...
                public void run() {
                    String title = "Failed";
                    String message = "";
                    String strUtl = "https://" + EactalkApp.HOST + "/bch/publish-transaction";
