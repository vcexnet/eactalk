...
package com.eactalk.tools.qrcode.xzing;
...
import com.eactalk.tools.qrcode.xzing.open.OpenCamera;
import com.eactalk.tools.qrcode.xzing.open.OpenCameraInterface;
        ...
        try {
            ...
            if (parametersFlattened != null) {
                ...
                try {
                    ...
                    // Well, darn. Give up
                    Timber.e(ex, "Camera rejected even safe-mode parameters! No configuration");
                }
            }
        }
