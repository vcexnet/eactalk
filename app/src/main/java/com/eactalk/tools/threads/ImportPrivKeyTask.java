...
//        String iso = BRSharedPrefs.getIso(app);
        ...
        String sentBits = BRCurrency.getFormattedCurrencyString(app, "EAC", BRExchange.getAmountFromSatoshis(app, "EAC", new BigDecimal(importPrivKeyEntity.getAmount())));
//        String sentExchange = BRCurrency.getFormattedCurrencyString(app, iso, BRExchange.getAmountFromSatoshis(app, iso, new BigDecimal(importPrivKeyEntity.getAmount())));
        ...
        String feeBits = BRCurrency.getFormattedCurrencyString(app, "EAC", BRExchange.getAmountFromSatoshis(app, "EAC", new BigDecimal(importPrivKeyEntity.getFee())));
