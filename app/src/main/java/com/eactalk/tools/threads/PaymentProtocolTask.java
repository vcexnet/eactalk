...
import com.eactalk.exceptions.CertificateChainNotFound;
...
import com.eactalk.tools.security.X509CertificateValidator;
...
import com.eactalk.tools.util.CustomLogger;
...
public class PaymentProtocolTask extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        app = (Activity) EactalkApp.getBreadContext();
        InputStream in;
        try {
