...
import com.eacpay.tools.util.BytesUtil;
...
////                    if (!((EacApp) app.getApplication()).hasInternetAccess())
////                        BreadDialog.
...
//            }
    ...
    public static void handleMessage() {
        ...
        if (app != null && message != null) {
            if (!message.isEmpty()) {
                BRToast.
                        showCustomToast(app, message, MainActivity.screenParametersPoint.y / 2, Toast.LENGTH_LONG, R.drawable.toast_layout_black);
            } else {
