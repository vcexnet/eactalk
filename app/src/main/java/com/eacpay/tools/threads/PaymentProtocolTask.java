...
import com.eacpay.tools.security.X509CertificateValidator;
...
import com.eacpay.tools.util.CustomLogger;
...
public class PaymentProtocolTask extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        app = (Activity) EacApp.getBreadContext();
        InputStream in;
        try {
