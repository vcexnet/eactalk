package com.eacpay.tools.listeners;
    ...
    protected void onHandleIntent(Intent workIntent) {
        if (workIntent != null)
            if (SYNC_RECEIVER.equals(workIntent.getAction())) {
                app = getApplication();
//                BRToast.showCustomToast(getApplication(), "Starting background syncing...", MainActivity.screenParametersPoint.y / 2, Toast.LENGTH_LONG, 0);
