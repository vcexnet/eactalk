...
//    }
    ...
    public static void animateSignalSlide(ViewGroup signalLayout, final boolean reverse, @Nullable final OnSlideAnimationEnd listener) {
        ...
        signalLayout.animate().translationY(reverse ? MainActivity.screenParametersPoint.y : translationY).setDuration(SLIDE_ANIMATION_DURATION)
