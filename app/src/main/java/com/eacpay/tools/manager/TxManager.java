...
import com.eacpay.tools.listeners.RecyclerItemClickListener;
...
public class TxManager {
    ...
    public void init(final Activity app, RecyclerView messageList) {
        txList = messageList;
            ...
            public void onItemClick(View view, int position, float x, float y) {
                if (currentPrompt == null || position > 0)
                    ...
                    if (x > view.getWidth() - 100 && y < 100) {
                        view.animate().setDuration(150).translationX(MainActivity.screenParametersPoint.x).setListener(new AnimatorListenerAdapter() {
                            @Override
