...
import com.eacpay.tools.animation.DecelerateOvershootInterpolator;
import com.eacpay.tools.security.AuthManager;
import com.eacpay.tools.security.FingerprintUiHelper;
...
//                dismiss();
    ...
    private void animateSignalSlide(final boolean reverse) {
        ...
        if (!reverse) {
            fingerPrintLayout.setTranslationY(layoutTY + MainActivity.screenParametersPoint.y);
