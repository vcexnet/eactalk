...
import com.eacpay.presenter.customviews.BRToast;
...
public class WithdrawBchActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String iso = BRSharedPrefs.getPreferredLTC(this) ? "EAC" : BRSharedPrefs.getIso(this);
        BigDecimal amount = iso.equalsIgnoreCase("EAC") ?
        ...
        String balance = BRCurrency.getFormattedCurrencyString(this, "EAC", amount);
        ...
        txHash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BRToast.showCustomToast(WithdrawBchActivity.this, getString(R.string.BCH_hashCopiedMessage), MainActivity.screenParametersPoint.y / 2, Toast.LENGTH_LONG, 0);
            }
        });
        ...
        scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BRAnimator.openScanner(WithdrawBchActivity.this, BRConstants.SCANNER_BCH_REQUEST);
            }
        });
        updateUi(this);
    }
    ...
    public static void setBCHTxId(String txId) {
        ...
        if (app != null) {
            ...
            Context activity = EacApp.getBreadContext();
