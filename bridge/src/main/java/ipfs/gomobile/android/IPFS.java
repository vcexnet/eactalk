...
public class IPFS {
    ...
    synchronized public void restart() throws NodeStopException {
        ...
        try {
            start();
        } catch (NodeStartException ignore) { /* Should never happen */ }
    }
    ...
    synchronized public void setConfigKey(@NonNull String key, @NonNull JSONObject value)
        ...
        try {
            ...
            Log.e("oldfeel", "setConfigKey: " + ipfsConfig.toString());
    ...
    synchronized public void setBootstrap(String value) throws ConfigSettingException {
        Objects.requireNonNull(value, "value should not be null");

        try {
            openRepoIfClosed();
            Config ipfsConfig = repo.getConfig();
            ipfsConfig.setKey("Bootstrap", value.getBytes());
            repo.setConfig(ipfsConfig);
        } catch (Exception e) {
            throw new ConfigSettingException("Config setting failed", e);
        }
    ...
    public String add(byte[] data) throws Exception {
        return shell.add(data);
    }

    public String addW(byte[] data, String name) throws Exception {
        return shell.addW(data, name);
    }
    ...
    public static class ExtraOptionException extends Exception {
        ExtraOptionException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class ConfigCreationException extends Exception {
        ConfigCreationException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class ConfigGettingException extends Exception {
        ConfigGettingException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class ConfigSettingException extends Exception {
        ConfigSettingException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class NodeStartException extends Exception {
        NodeStartException(String message) {
            super(message);
        }

        NodeStartException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class NodeStopException extends Exception {
        NodeStopException(String message) {
            super(message);
        }

        NodeStopException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class SockManagerException extends Exception {
        SockManagerException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class RepoInitException extends Exception {
        RepoInitException(String message) {
            super(message);
        }

        RepoInitException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class RepoOpenException extends Exception {
        RepoOpenException(String message, Throwable err) {
            super(message, err);
        }
    }

    public static class ShellRequestException extends Exception {
        ShellRequestException(String message) {
            super(message);
        }
    }
}
